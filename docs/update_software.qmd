...
3. Reapply the Ansible desired state after the software updates.
...
- A **DNF user-installed but Ansible-unmanaged package** is tracked by RPM/DNF, but is not declared in this repository's managed package lists or package allowlists.
