...
`make deps` installs or updates the exact Ansible Galaxy collection versions in
`requirements.yml`. These versions are intentionally pinned so tagged releases
use the same tested dependencies on every workstation.
