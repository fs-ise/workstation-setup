...
This setup is tested/supported on **Fedora Workstation 44 x86_64**. The main
Ansible playbook rejects other distributions, Fedora major versions, and
architectures before running installation or configuration roles.
:::
