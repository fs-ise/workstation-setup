...
Install BorgBackup and the optional Vorta GUI. The `borg_vorta` role installs tools only; it does not create repositories, store credentials, choose destinations, or schedule backups.
