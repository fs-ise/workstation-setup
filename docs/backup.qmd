...
Install BorgBackup and the optional Vorta GUI. The role installs tools only; it does not create repositories, store credentials, choose destinations, or schedule backups.
...
Create or reconnect backup repositories and configure credentials, destinations, retention, and schedules in Vorta or Borg.
:::
