...
Installs the pinned Thunderbird MCP Node.js bridge and merges its `normal_installed` extension entry into the existing Thunderbird Enterprise Policies document. The role preserves unrelated policies and extensions.
